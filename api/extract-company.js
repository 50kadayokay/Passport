    ...
    properties: {
      ...
      capital: {
        ...
        properties: {
          ...
          headline: { type: "string", description: "One-line capital-status headline IF supportable, e.g. 'Fully funded through 2026'." },
          subtext: { type: "string", description: "One sentence backing the headline." },
